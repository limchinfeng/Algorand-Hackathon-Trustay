    ...
    <div className="flex flex-row">
      ...
      <div className="w-6/12 flex flex-col gap-2 ">
        ...
        <div className="text-justify">
            ...
            <br />
            <p>
                As the story unfolds, we will keep you updated on the resolution and how these two individuals are managing the situation, reinforcing the notion that hospitality and goodwill can prevail even in challenging circumstances.
            </p>
        </div>
      </div>
    </div>
